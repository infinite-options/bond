...
namespace BondMobileApp.Pages
{
    public partial class MovieQuestionPage : ContentPage
    {
        ...
        public List<Henchmen> HenchmenList = new List<Henchmen>();
        ...
        public ObservableCollection<Henchmen> HenchmenDetails = new ObservableCollection<Henchmen>();
        ...
        async void LocalHenchmen()
        {
            ...
            foreach (Henchmen item in HenchmenList)
            {
